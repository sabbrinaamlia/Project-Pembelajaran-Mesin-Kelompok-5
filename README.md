...
Support Vector Machine (SVM) menggunakan fitur morfologi hasil ekstraksi nucleus. Convolutional Neural Network (CNN) menggunakan citra hasil preprocessing secara langsung.
...
🎯 Tujuan Melakukan preprocessing citra sel darah menggunakan segmentasi nucleus. Mengekstraksi fitur morfologi nucleus. Membangun model klasifikasi menggunakan SVM. Membangun model klasifikasi menggunakan CNN. Membandingkan performa kedua model menggunakan berbagai metrik evaluasi. 📂 Dataset
...
Basophil Erythroblast Monocyte Myeloblast Segmented Neutrophil
